...
// REST-контроллер, обрабатывает запросы API для управления пользователями, начинающиеся с "/api/"
// получаем всех, одного, обновляем, удаляем. Обрабатываем исключения, возвращаем ответ и статус ошибки
