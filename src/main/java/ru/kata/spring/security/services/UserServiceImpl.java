...
//  UserServiceImpl является службой (service). отвечает за обработку и управление данными пользователей.
// предоставляет реализацию основных операций управления пользователями, используя методы userRepository и roleRepository,
// а также обеспечивает шифрование паролей при сохранении и обновлении пользователей.
@Service
