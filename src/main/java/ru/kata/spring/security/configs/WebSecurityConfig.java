...
// конфигурационный класс для SS, который определяет правила аутентификации и авторизации веб-приложения.
//  определяем основную конфигурацию безопасности. Правила доступа к различным URL на основе ролей пользователей,
//  настраиваем форму входа и выхода из системы, какие компоненты использовать для получения информации о пользователях
